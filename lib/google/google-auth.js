...
export function authorize(callback) {
  ...
  console.log('JSON.parse(GOOGLE_CREDENTIALS_JSON).web: ', JSON.parse(GOOGLE_CREDENTIALS_JSON).web);
  ...
  console.log('JSON.parse(GOOGLE_TOKEN_JSON): ', JSON.parse(GOOGLE_TOKEN_JSON));
...
//     spreadsheetId: '15qJi39meo8qPe_7dXblg-CMiET_rVCuBguwXhxrcQm0',
//     range: 'Предписания!A:K',
//   }, (err, res) => {
